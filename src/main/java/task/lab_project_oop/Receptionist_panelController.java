...
public class Receptionist_panelController {

    @FXML
    private Button searchAppointment_button;
    ...
    public void initialize(){
        searchAppointment_button.setOnAction(this::searchAppointment_button_handler);
    ...
    @FXML
    void searchAppointment_button_handler(ActionEvent event) {
        Move_page.navigateToPage(event, "Receptionist_SearchAppointment.fxml");
    ...
    void View_Profile_handler(ActionEvent event) {
        ...
        try {
            ...
            String query = "SELECT * FROM receptionist WHERE Username = ? AND Password = ? AND user = ?";
