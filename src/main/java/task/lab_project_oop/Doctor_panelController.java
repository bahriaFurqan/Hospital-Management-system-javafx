...
public class Doctor_panelController {
...
Logout.setOnAction(this::Logouthandler);
    ...
    void Appointment_button_handler(ActionEvent event) {
        Move_page.navigateToPage(event,"Doctor_Viewappointment.fxml");
    ...
    void View_Profile_handler(ActionEvent event) {
        ...
        try {
            ...
            String user = "Doctor";
            String query = "SELECT * FROM doctor WHERE Username = ? AND Password = ? AND user = ?";
